    ...
    <div className="fixed inset-0 bg-dark-bg flex flex-col items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        <button
          ...
          disabled={loading}
          type="button"
          className="w-full mb-4 px-4 py-3 bg-white text-gray-700 rounded font-semibold flex items-center justify-center gap-3 hover:bg-gray-100 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-dark-card text-gray-500">Or continue with username</span>
          </div>
        </div>
